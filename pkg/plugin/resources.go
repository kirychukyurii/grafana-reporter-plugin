...
func (a *App) registerRoutes() {
	...
	a.router.HandleFunc("/reports", a.handler.NewReport).Methods(http.MethodPut)
	a.router.HandleFunc("/reports/{id:[0-9]+}", a.handler.UpdateReport).Methods(http.MethodPatch)
